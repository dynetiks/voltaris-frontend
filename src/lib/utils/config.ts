...
const getConfig: () => {
  ...
  return {
    appName: process.env.NEXT_PUBLIC_APP_NAME || 'Voltaris',
    ...
    operatorEmail: process.env.NEXT_PUBLIC_OPERATOR_EMAIL,
    operatorPassword: process.env.OPERATOR_PASSWORD,
    operatorIds: parseCsvEnv(process.env.NEXT_PUBLIC_OPERATOR_IDS),
    stationEmail: process.env.NEXT_PUBLIC_STATION_EMAIL,
    stationPassword: process.env.STATION_PASSWORD,
    stationIds: parseCsvEnv(process.env.NEXT_PUBLIC_STATION_IDS),
    stationChargerIds: parseCsvEnv(process.env.NEXT_PUBLIC_STATION_CHARGER_IDS),
    stationOperatorIds: parseCsvEnv(process.env.NEXT_PUBLIC_STATION_OPERATOR_IDS),
    authProvider,
